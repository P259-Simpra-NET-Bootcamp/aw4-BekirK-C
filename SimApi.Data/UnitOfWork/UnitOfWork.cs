...
public class UnitOfWork : IUnitOfWork
{
    ...
    public IGenericRepository<TransactionView> EfTransactionRepository { get; private set; }
    ...
    public UnitOfWork(SimEfDbContext dbContext, SimDapperDbContext dapperDbContex)
    {
        ...
        DapperCategoryRepository = new DapperRepository<Category>(dapperDbContext);
